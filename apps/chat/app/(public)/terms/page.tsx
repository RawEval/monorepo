  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#e5e7eb', padding: '2rem 1rem' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 600, color: '#f9fafb', margin: '0 0 0.5rem' }}>Terms of Service</h1>
        ...
        <nav style={{ display: 'flex', gap: '1rem', marginBottom: '2rem', fontSize: '0.875rem' }}>
          <span style={{ color: '#6366f1', fontWeight: 500 }}>Terms of Service</span>
        ...
        {data ? (
          ...
          <p style={{ color: '#9ca3af' }}>Unable to load terms of service. Please try again later.</p>
        )}
      </div>
    </div>
  );
