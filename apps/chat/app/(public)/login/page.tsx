        ...
        >
          ...
          <CardContent className="space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border-2 border-[#dadce0] bg-white px-4 py-3 text-sm font-medium text-[#3c4043] shadow-sm transition-all hover:border-[#d2e3fc] hover:bg-[#f8faff] active:bg-[#e8eaed] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isGoogleLoading ? (
